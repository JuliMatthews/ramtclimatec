...
CMD bash -c "php artisan migrate --force && php artisan storage:link && php artisan filament:assets && php artisan config:cache && php artisan view:cache && frankenphp run --config /etc/caddy/Caddyfile"